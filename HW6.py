...
def films():
    ...
    actors = get_db_result(f'SELECT * FROM actor ')
    genres = get_db_result(f'SELECT * FROM genre ')
    countries = get_db_result(f'SELECT * FROM country')
    return render_template('films.html', films=result, countries = countries, actors = actors, genres = genres)
