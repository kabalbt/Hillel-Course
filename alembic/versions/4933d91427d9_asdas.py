...
Revision ID: 4933d91427d9
Revises: 
Create Date: 2026-01-11 21:28:30.393900
...
def upgrade() -> None:
    ...
    sa.PrimaryKeyConstraint('id', 'actor_id', 'film_id')
    )
    ...
    sa.PrimaryKeyConstraint('id', 'genre_id', 'film_id')
    )
